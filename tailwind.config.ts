  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Vyom futuristic color palette
        vyom: {
          blue: "#0066FF",      // Bright blue
          navy: "#001E60",      // Dark blue
          red: "#FF3A5E",       // Bright red
          light: "#F5F9FF",     // Light background
          gray: "#536080",      // Modern gray
          teal: "#00C2FF",      // Bright teal
          accent: "#4C7FFF",    // Accent blue
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 10px rgba(0, 102, 255, 0.5)" },
